    ...
    <body>
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                ...
                <ul class="nav pull-right">
                            <li>
                                <a target="_blank" href="http://github.com/afaqurk/linux-dash">
        ...
        <div class="subnavbar">
            ...
            <li class="dropdown">
                ...
                <span>PHPInfo <i class="icon-caret-down"></i></span>
                </a>
                            <ul class="dropdown-menu" id="phpinfo-widget-opt">
                                <li><a href="module.php?module=phpinfo&what=-1" target="_blank"><i class="icon-info"></i> - INFO_ALL</a></li>
                                <li><a href="module.php?module=phpinfo&what=1" target="_blank"><i class="icon-info"></i> - INFO_GENERAL</a></li>
                                <li><a href="module.php?module=phpinfo&what=4" target="_blank"><i class="icon-info"></i> - INFO_CONFIGURATION</a></li>
                                <li><a href="module.php?module=phpinfo&what=8" target="_blank"><i class="icon-info"></i> - INFO_MODULES</a></li>
                                <li><a href="module.php?module=phpinfo&what=16" target="_blank"><i class="icon-info"></i> - INFO_ENVIRONMENT</a></li>
                                <li><a href="module.php?module=phpinfo&what=32" target="_blank"><i class="icon-info"></i> - INFO_VARIABLES</a></li>
                                <li><a href="module.php?module=phpinfo&what=2" target="_blank"><i class="icon-info"></i> - INFO_CREDITS</a></li>
                            </ul>
                        </li>
                    </ul>
                </div><!-- /container -->
            ...
            <div class="main-inner">
                    ...
                    <div id="widgets" class="row">
                                ...
                                <div id="general-info-widget" class="widget widget-table action-table">
                                    ...
                                    <div class="widget-content">
                                        ...
                                        <div class="general-info-item">
                                            ...
                                            <span id="os-uptime"> `uptime /bin/cat /proc/loadavg | /usr/bin/awk '{print $3}'` Minutes</span>
                                        </div>
                                        <div class="general-info-item">
                                        ...
                                        <div class="big-stats-container">
                                            <div class="widget-content">
                                                <div class="cf big_stats">
                                                    ...
                                                    <div class="stat">
                                                        <i class="icon-#">Free&nbsp;</i> <span id="ram-free"></span><h2><font color="#303A34"> `free -h | grep Mem | /usr/bin/awk '{print $3}'`</font></h2><br>
                        ...
                        <div class="span6">
                                <div id="software-widget" class="widget widget-table">
                                    ...
                                    <div class="widget-content">
                                        <table id="whereis_dashboard" class="table table-hover table-condensed table-bordered"> <pre><h5><font color="#303A34"> `ifconfig -a` </font></h5></pre> </table>
                                    </div><!-- /widget-content -->
                                </div><!-- /widget -->
                            </div><!-- /span6 -->
                        ...
                        <div class="span4">
                                <div id="ping-widget" class="widget widget-table">
                                    <div class="widget-header">
                                        ...
                                        <div id="refresh-ping" class="btn js-refresh-info"><span class="icon-refresh"></span></div>
                                    </div>
                                    <div class="widget-content">
                        ...
                        <div class="span4">
                                <div id="bandwidth-widget" class="widget widget-table">
                                    <div class="widget-header">
                                        ...
                                        <div id="refresh-bandwidth" class="btn js-refresh-info"><span class="icon-refresh"></span></div>
                                    </div><!-- /widget-header -->
                                    <div class="widget-content">
                        ...
                        <div class="span4">
                                <div id="users-widget" class="widget widget-table action-table">
                                    ...
                                    <div class="widget-content">
                                        <table id="users_dashboard" class="table table-hover table-bordered table-condensed"><pre><h5><font color="#303A34"> `cat /proc/cpuinfo` </font></h5></pre> </table>
                                    </div><!-- /widget-content -->
                                </div><!-- /widget -->
                            </div><!-- /span4 -->
                        <div class="span4">
                        ...
                        <div class="span4">
                                <div id="lastlog-widget" class="widget widget-table action-table">
                                    ...
                                    <div class="widget-content">
                                        <table id="lastlog_dashboard" class="table table-hover table-bordered table-condensed"><pre><h5><font color="#303A34"> `last` </font></h5></pre>  </table>
                                    </div><!-- /widget-content -->
                                </div><!-- /widget -->
                            </div><!-- /span4 -->
                        ...
                        <div class="span12">
                            ...
                            <div class="span9">
                                <div id="swap-widget" class="widget widget-table">
                                    ...
                                    <div class="widget-content">
                                        <table id="swap_dashboard" class="table table-hover table-condensed table-bordered"> <pre><h5><font color="#303A34"> `netstat -tulpn` </font></h5></pre> </table>
                                    </div><!-- /widget-content -->
                                </div><!-- /widget -->
                            </div><!-- /span9 -->
              ...
              <div class="span17">
                                <div id="swap-widget" class="widget widget-table">
                                    ...
                                    <div class="widget-content">
                                        <table id="swap_dashboard" class="table table-hover table-condensed table-bordered"> <pre><h5><font color="#303A34"> `last` </font></h5></pre> </table>
                                    </div><!-- /widget-content -->
                                </div><!-- /widget -->
                            </div><!-- /span9 -->
			   ...
			   <div class="span6">
						...
						<div class="span3">
							<div id="redis-widget" class="widget widget-table action-table">
								<div class="widget-header">
									<i class="icon-list"></i>
									<h3>
										Redis Status
									</h3>
									<div id="refresh-redis" class="btn icon-refresh js-refresh-info"></div>
								</div><!-- /widget-header -->
								<div class="widget-content">
									<div id="redis-installed" class="hide">
										<div class="general-info-item">
											<span class="general-title">Version</span>
											<span class="general-data" id="version-info"></span>
										</div>
										<div class="general-info-item">
											<span class="general-title">Connected Clients</span>
											<span class="general-data" id="cc-info"></span>
										</div>
										<div class="general-info-item">
											<span class="general-title">Connected Slaves</span>
											<span class="general-data" id="cs-info"></span>
										</div>
										<div class="general-info-item">
											<span class="general-title">Used Memory</span>
											<span class="general-data" id="memory-info"></span>
										</div>
										<div class="general-info-item">
											<span class="general-title">Total connections recieved</span>
											<span class="general-data" id="totc-info"></span>
										</div>
										<div class="general-info-item">
											<span class="general-title">Total commands processed</span>
											<span class="general-data" id="totcp-info"></span>
										</div>

									</div>
									<div id="redis-not" class="hide">
										Redis not installed
									</div>
								</div><!-- /widget-content -->
							</div><!-- /widget -->
